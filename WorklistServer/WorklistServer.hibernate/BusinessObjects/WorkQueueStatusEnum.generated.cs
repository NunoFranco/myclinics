...
{
    public partial class WorkQueueStatusEnum : BusinessBase<string>
    {
        #region Declarations
		...
		private IList<WorkQueueItem> _workQueueItems = new List<WorkQueueItem>();
		...
		public virtual IList<WorkQueueItem> WorkQueueItems
        {
            get { return _workQueueItems; }
            set
			{
				OnWorkQueueItemsChanging();
				_workQueueItems = value;
				OnWorkQueueItemsChanged();
			}
        }
		partial void OnWorkQueueItemsChanging();
		partial void OnWorkQueueItemsChanged();
