    ...
    public partial class ServiceTypeForm : Form
    {
        ...
        private void buttonLoad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                List<ProcedureTypeSummary> ListServiceTypes = _component.ListProcedureType(ClearCanvas.Enterprise.Common.AuthenticationScope.Current.CurrentClinic.ClinicRef );
