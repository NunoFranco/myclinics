...
namespace ClearCanvas.Healthcare
{
	...
	public partial class PatientNoteCategorySearchCriteria : EntitySearchCriteria<PatientNoteCategory>
	{
		...
		public override object Clone()
        {
	  	...
	  	public ISearchCondition<ClearCanvas.Healthcare.NoteSeverityEnum> Severity
	  	{
	  		get
	  		{
	  			if(!this.SubCriteria.ContainsKey("Severity"))
	  			{
	  				this.SubCriteria["Severity"] = new SearchCondition<ClearCanvas.Healthcare.NoteSeverityEnum>("Severity");
	  			}
	  			return (ISearchCondition<ClearCanvas.Healthcare.NoteSeverityEnum>)this.SubCriteria["Severity"];
	  		}
	  	}
