...
namespace ClearCanvas.Enterprise.Authentication
{
	...
	public partial class User : ClearCanvas.Enterprise.Core.Entity
	{
	  	...
	  	/// </summary>
	  	public User(string username1, ClearCanvas.Enterprise.Authentication.Password password1, string displayname1, DateTime? validfrom1, DateTime? validuntil1, bool enabled1, DateTime creationtime1, DateTime? lastlogintime1, ISet<ClearCanvas.Enterprise.Authentication.AuthorityGroup> authoritygroups1, ISet<ClearCanvas.Enterprise.Authentication.UserSession> sessions1, ISet<ClearCanvas.Enterprise.Authentication.Clinic> clinics1)
			:base()
	  	{
		  	CustomInitialize();
