    ...
    public partial class frmSetPrimaryCurrency : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(IsPrimaryCurrencyChanged ? SR.ConfirmPrimaryCurrencyChanged : SR.ConfirmPrimaryExRateCurrencyChanged, "", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                {
                    ClearCanvas.Ris.Application.Common.Billing.ServiecInterfaces.BillingDTO.ChangePrimaryCurrencyRequest request = new ClearCanvas.Ris.Application.Common.Billing.ServiecInterfaces.BillingDTO.ChangePrimaryCurrencyRequest(
                        ListCurreices,
