...
namespace ClearCanvas.Ris.Client.Billing.View.WinForms
{
    public partial class ModalitiesForm : Form
    {
        ...
        private void ModalitiesForm_Load(object sender, EventArgs e)
        {
            ...
            //reports.Modalities reportModality = new ClearCanvas.Ris.Billing.View.WinForms.reports.Modalities();
        ...
        {
            reports.Modalities reportDocument = new reports.Modalities();
            reportDocument.Subreports["HospitalInfoHeader.rpt"].SetDataSource(reports.LoadHospitalInfo.GetHospitalInfoDataSource());
            if (datasource != null)
            {
        ...
        {
            reports.Modalities f = new reports.Modalities();
