...
namespace ClearCanvas.Ris.Billing.View.WinForms
{
    public partial class EditProcedureAdjestmentPrice : Form
    {
        ...
        //                   {
        //                       ClearCanvas.Ris.Application.Common.Billing.ServiecInterfaces.Billing.ListCurrencyRequest request = new ClearCanvas.Ris.Application.Common.Billing.ServiecInterfaces.Billing.ListCurrencyRequest();
