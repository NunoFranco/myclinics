...
{
    public class DiscountRule : ClearCanvas.Enterprise.Core.Entity
    {
        ...
        [PersistentProperty]
        public virtual string DiscountRuleID { get; set; }
        [PersistentProperty]
        public virtual DiscountTypeEnum ClassID { get; set; }
        [PersistentProperty]
        ...
        public DiscountRule(DiscountTypeEnum classID, ProcedureType procedureTypeID_, string ruleCode, string ruleName,
