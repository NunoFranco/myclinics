...
namespace ClearCanvas.Healthcare
{
	...
	public sealed partial class PatientAttachment : ValueObject, IEquatable<PatientAttachment>, IAuditFormattable
	{
	  	...
	  	/// </summary>
	  	public PatientAttachment(ClearCanvas.Healthcare.PatientAttachmentCategoryEnum category1, ClearCanvas.Healthcare.Staff attachedby1, DateTime attachedtime1, ClearCanvas.Healthcare.AttachedDocument document1, ClearCanvas.Healthcare.Facility clinic1)
	  	{
		  	CustomInitialize();
	  	...
	  	public bool Equals(PatientAttachment that)
		{
			...
			((this._category == default(ClearCanvas.Healthcare.PatientAttachmentCategoryEnum)) ? (that._category == default(ClearCanvas.Healthcare.PatientAttachmentCategoryEnum)) : this._category.Equals(that._category)) &&
